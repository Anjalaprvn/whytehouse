...
urlpatterns = [
    ...
    path('leads/<int:lead_id>/assign/', views.assign_lead_employee, name='assign_lead_employee'),
    ...
    path("hospitality-management/check-duplicate/", views.check_property_duplicate, name="check_property_duplicate"),
    ...
    path('travel-packages/check-name/', views.check_package_name, name='check_package_name'),
    ...
    path('destinations/toggle/<int:destination_id>/', views.toggle_destination_status, name='toggle_destination_status'),
    path('destinations/check-name/', views.check_destination_name, name='check_destination_name'),
